...
class Network:
    def __init__(self, args, num_words, num_tags):
        ...
        # TODO: Embed input words with dimensionality `args.we_dim`, using `mask_zero=True`.
        embedded_word_ids = tf.keras.layers.Embedding(num_words, args.we_dim, mask_zero=True)(word_ids)
        ...
        # opposite directions.
        x = tf.keras.layers.Bidirectional(self._get_cell(args.rnn_cell, args.rnn_cell_dim))(embedded_word_ids)
